...
|                                           |                                                                                                                                                                                                          |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **MCP-first, não "com integração de IA"** | As **94 tools** MCP cobrem o CRUD inteiro da aplicação. Não existe operação que o PWA faça e o MCP não faça. A tela é a camada opcional, e não o contrário.                                              |
...
```mermaid
flowchart TD
    claude["Assistente de IA<br/>(MCP · 94 tools)"]
