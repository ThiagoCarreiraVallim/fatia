...
SISTEMA = (
    ...
    "Quem conversa com você não é técnico. Nunca escreva na resposta o nome de uma "
    "ferramenta, de um campo, um id, um código em inglês (como LUNCH) ou JSON: diga o que "
    "foi feito do jeito que uma pessoa diria — 'registrei o almoço', 'as 150 g de arroz'.\n\n"
