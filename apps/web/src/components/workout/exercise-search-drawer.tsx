            ...
            {filtered?.map((exercise) => (
              <li key={exercise.id} className="flex items-center">
                <button
                  ...
                  className="flex flex-1 items-center justify-between px-4 py-3 text-left hover:bg-accent"
                >
                  <div>
                ...
                <button
                  ...
                  className="shrink-0 px-3 py-3 text-muted-foreground hover:text-foreground"
                >
                  <Info size={18} />
                </button>
              </li>
