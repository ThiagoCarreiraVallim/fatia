...
export function SwapLabel({
  ...
  useLayoutEffect(() => {
    ...
    // `layers` fora das dependências, de propósito: o array é literal e nasce de
    // novo a cada render, então listá-lo desmontaria e remontaria o
    // `ResizeObserver` em todo render. As duas refs que ele guarda são estáveis,
    // que é o que o efeito de fato usa.
