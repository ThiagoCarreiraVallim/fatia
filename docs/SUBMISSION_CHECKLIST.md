...
submissão não avança, e são **90 tools** afetadas.
...
- [ ] Preencher nas 90 tools. A separação é mecânica pelo prefixo do nome:
...
### A7. Exercitar as 90 tools de ponta a ponta 🟠 (#171)
...
- [ ] Rodar as 90 tools no [MCP Inspector](https://modelcontextprotocol.io/docs/tools/inspector).
...
1. **#169** (anotações das 90 tools) — único bloqueador puramente de código, e o passo
...
4. **#91 + #171** (validar o fluxo no Claude; exercitar as 90 tools no Inspector e no
