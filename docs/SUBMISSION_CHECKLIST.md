...
submissão não avança, e são **91 tools** afetadas.
...
- [ ] Preencher nas 91 tools. A separação é mecânica pelo prefixo do nome:
...
### A7. Exercitar as 91 tools de ponta a ponta 🟠 (#171)
...
- [ ] Rodar as 91 tools no [MCP Inspector](https://modelcontextprotocol.io/docs/tools/inspector).
...
1. **#169** (anotações das 91 tools) — único bloqueador puramente de código, e o passo
...
4. **#91 + #171** (validar o fluxo no Claude; exercitar as 91 tools no Inspector e no
